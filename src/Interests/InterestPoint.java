...
public class InterestPoint implements Serializable{
    ...
    public float getNoteMoyenne(){
        if(this.m_note.size() == 0) return Integer.MAX_VALUE;
    ...
    public void setCoordinate(double lat, double lon){
        this.m_coordinate.setLat(lat); this.m_coordinate.setLon(lon);
    }
    ...
    public String toString() {
        return "InterestPoint{" +
                ...
                "\n\tlodgings=" + lodgings +
                "\n\tCoordonnées m_coordinate = (" + m_coordinate.getLat() + ", " + +m_coordinate.getLon() + ")" +
                "\n}";
    }
}
