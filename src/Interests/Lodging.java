...
public class Lodging implements Serializable{
    ...
    public float getNightCost(){ return this.m_nightCost;}
 
    public void setNightCost(float cost){ this.m_nightCost = cost; }

    public void setName(String name){ this.m_name = name; }
    
    public String getName(){return this.m_name;}
    
    public String toString() { return "Lodging "+this.m_name+" : "+this.m_nightCost+" euros/night."; }
}
